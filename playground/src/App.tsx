    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.card}>
        ...
        <p className={styles.subtitle}>
          Scroll in any direction and the axis will auto-switch based on the
          dominant movement. The card stays fixed while the background stage
          scrolls.
        </p>
        ...
        <div className={styles.grid}>
          {entries.map((entry) => (
            <div key={entry.label} className={styles.stat}>
              <div className={styles.statLabel}>{entry.label}</div>
              <div className={styles.statValue}>{entry.value}</div>
            </div>
          ))}
        </div>
      </div>
